...
class FastKey extends Component {
  ...
  tryWord = () => {
    ...
    // console.log(this.state.wordPlayer);
  ...
  inputPlayerUI = () => {
    const test = this.state.wordToWrite;
    console.log(test);
    if (this.state.wordToWrite === "The game is already started wait the end") {
      return (
        <Pane>
      ...
      this.state.wordToWrite === "You lose" ||
      this.state.wordToWrite === "You win"
    ) {
      return (
        <Pane>
